...
final class SweepTarget
{
    ...
    /**
     * Как назвать цель в отчёте.
     *
     * Печатать id недостаточно: у вебхука он в удалении не участвует вовсе, и
     * строка «webhooks 0 — причина» не даёт оператору того, чем добивать
     * руками. Печатаем то, чем сущность адресуется на самом деле.
     */
